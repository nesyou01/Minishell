...
SRC = src/main.c src/minishell.c src/utils/utils.c src/builtins/env.c src/utils/malloc_utils.c \
		...
		src/parser/filter.c src/parser/var_utils.c src/execution/execute_builtin.c src/parser/expander3.c src/parser/node_utils2.c
...
READLINE = /mnt/homes/$(USER)/.brew/opt/readline
